...
const analytics_45global = defineNuxtRouteMiddleware((to, from) => {
...
const vuetify_WIue46TOniyjkogbUIE0Q_xwWw7mT5k7_LeS4ZtT8SM = defineNuxtPlugin((nuxtApp) => {
  const vuetify = createVuetify({
    components: index$1,
    directives: index,
    ssr: true,
    // Enable SSR for Vuetify
    theme: {
      defaultTheme: "light",
      // Default theme
      themes: {
...
const router_xzM48dudz8i7nmzwBmzp6Ht9_SIiUsNJVx8nNQoi_do = defineNuxtPlugin((nuxtApp) => {
  const router = useRouter$1();
  router.afterEach((to) => {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(_component_v_card, {
                          elevation: "10",
                          class: "pa-6 text-center rounded-xl error-card"
                        }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(_component_v_sheet, { class: "error-code" }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`${ssrInterpolate(__props.error.statusCode)}`);
                                  } else {
                                    return [
                                      createTextVNode(toDisplayString(__props.error.statusCode), 1)
                                    ];
                                  }
                                }),
                                _: 1
                              }, _parent5, _scopeId4));
                              _push5(ssrRenderComponent(_component_v_sheet, { class: "error-message" }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(` Oops! Something went wrong. `);
                                  } else {
                                    return [
                              ...
                              _push5(`<p class="error-description" data-v-30dc331b${_scopeId4}>${ssrInterpolate(__props.error.message || "We couldn't find what you were looking for.")}</p>`);
                              _push5(ssrRenderComponent(_component_v_btn, {
                                color: "primary",
                                class: "mt-4 error-btn",
                              ...
                              return [
                                createVNode(_component_v_sheet, { class: "error-code" }, {
                                  default: withCtx(() => [
                                    createTextVNode(toDisplayString(__props.error.statusCode), 1)
                                  ]),
                                  _: 1
                                }),
                                createVNode(_component_v_sheet, { class: "error-message" }, {
                                  default: withCtx(() => [
                                    createTextVNode(" Oops! Something went wrong. ")
                                  ]),
                                  _: 1
                                }),
                                createVNode("p", { class: "error-description" }, toDisplayString(__props.error.message || "We couldn't find what you were looking for."), 1),
...
const ErrorComponent = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-30dc331b"]]);
...
export { _export_sfc as _, useDisplay as a, server as s, useRuntimeConfig as u };
