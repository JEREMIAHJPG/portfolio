  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { property: 'og:image', content: '/3d-showcase.svg' },
        { property: 'og:url', content: 'https://asastra.vercel.app' },
        { name: 'twitter:card', content: 'summary_large_image' },
        { name: 'twitter:title', content: 'Asastra' },
        { name: 'twitter:description', content: 'Artists & Tech Platform' },
        { name: 'twitter:image', content: 'https://asastra.vercel.app/mylogomedium.jpg' },
